Espo.define('phlebfinders:views/assignment/fields/item-list', ['views/fields/base', 'model'], function (Dep, Model) {

    return Dep.extend({

        detailTemplate: 'phlebfinders:assignment/fields/item-list/detail',

        listTemplate: 'phlebfinders:assignment/fields/item-list/detail',

        editTemplate: 'phlebfinders:assignment/fields/item-list/edit',
        ...
        setup: function () {
            ...
            var calculationHandlerClassName =
                ...
                'phlebfinders:assignment-calculation-handler';
        ...
        afterRender: function () {
            ...
            var itemListViewName =
                ...
                ||
                'phlebfinders:views/assignment/record/item-list';
