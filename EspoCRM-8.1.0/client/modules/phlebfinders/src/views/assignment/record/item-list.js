Espo.define('phlebfinders:views/assignment/record/item-list', ['views/base', 'collection'], function (Dep, Collection) {

    return Dep.extend({

        template: 'phlebfinders:assignment/record/item-list',
                ...
                this.getModelFactory().create(this.itemEntityType, function (modelSeed) {
                    itemList.forEach(function (item, i) {
                        ...
                        var viewName = this.getMetadata().get(['clientDefs', this.itemEntityType, 'recordViews', 'item']) ||
                            'phlebfinders:views/assignment/record/item';
